  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 flex flex-row items-center justify-between border-t border-gray-700  text-center text-sm text-white md:text-base space-y-4 ">
          <div className="pt-4">
            <img src={mlogo} className=" h-12 mx-auto" alt="Company Logo" />
          </div>
          ...
          <div className="flex flex-row  justify-center space-x-4 text-white ">
