      ...
      <div className="font-[sans-serif] max-w-6xl mx-auto relative rounded-lg py-6">
        <div className="grid lg:grid-cols-3 items-center">
          <div className="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:px-4">
            <Link to="/map" className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
            ...
            <Link to="tel:8319955741" className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              <LuPhoneCall className="w-7 text-3xl" />
              <h4 className="text-gray-800 text-base font-bold mt-4">
                Call us
              </h4>
              <Link to="tel:8319955741" className="text-sm text-gray-600 mt-2">8319955741</Link>
            </Link>
            <Link to="https://wa.me/8319955741" target="_blank" rel="noreferrer noopener" className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
            ...
            <div className="grid sm:grid-cols-2  items-center justify-center rounded-lg  h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              <Link to="https://www.instagram.com/manasvi.technologies/?igshid=NTc4MTIwNjQ2YQ%3D%3D" target="_blank" rel="noreferrer noopener" className=" flex items-center justify-center">
              ...
              <Link to="https://www.facebook.com/people/Manasvi-Technologies-OPC-Pvt-Ltd/61555158365754/" target="_blank" rel="noreferrer noopener" className=" flex items-center justify-center">
              ...
              <Link to="https://www.linkedin.com/authwall?trk=bf&trkInfo=AQHAAqowuN-m9AAAAZDAuUoY5uxO81U7SEwFB42PI9wsJ2PJ_yCmar--HYuTGEQnqKueTr__SIp9r42Rur5oDJjqQY4QKWA981SoUAaS5jYta0xWrl2F2EU8duJ07NHIV8zFT5A=&original_referer=&sessionRedirect=https%3A%2F%2Fwww.linkedin.com%2Fin%2Fmanasvi-technologies-7aa426262%2F" target="_blank" rel="noreferrer noopener" className=" flex items-center justify-center">
              ...
              <Link to="https://x.com/i/flow/login?redirect_after_login=%2Fmanasvitech01" target="_blank" rel="noreferrer noopener" className=" flex items-center justify-center">
